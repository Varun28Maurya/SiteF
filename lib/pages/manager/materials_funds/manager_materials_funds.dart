...
/// PAGE
/// ============================================================
class ManagerMaterialsFundsPage extends StatefulWidget {
  final String role; // ENGINEER / MANAGER
  const ManagerMaterialsFundsPage({super.key, this.role = "Manager"});

  @override
  State<ManagerMaterialsFundsPage> createState() => _ManagerMaterialsFundsPageState();
}

class _ManagerMaterialsFundsPageState extends State<ManagerMaterialsFundsPage> {
