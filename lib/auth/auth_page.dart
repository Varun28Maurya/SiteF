...
class MockDetailsDB {
  static final owners = <AuthUser>[
    AuthUser(
        id: "owner-1", name: "Amit Patel", phone: "9876543210", role: "OWNER"),
  ];
  ...
  static final managers = <AuthUser>[
    AuthUser(
        id: "mgr-1",
        name: "Suresh Yadav",
        phone: "9000000001",
  ...
  static final clients = <AuthUser>[
    AuthUser(
        id: "cli-1", name: "Ramesh Verma", phone: "9000000002", role: "CLIENT"),
  ];
...
class _AuthPageState extends State<AuthPage> with TickerProviderStateMixin {
  ...
  Future<void> _saveLocalUser(AuthUser user) async {
    ...
    await prefs.setString(
        "users", jsonEncode(list.map((e) => e.toJson()).toList()));
  }
